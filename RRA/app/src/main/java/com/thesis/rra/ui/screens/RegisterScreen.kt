...
import com.thesis.rra.ui.theme.Purple80
...
fun RegisterScreenUI(navController: NavController) {
    ...
    Column(
        ...
        TextField(
            label = { Text(text = AnnotatedString("Email")) },
            value = email.value,
        ...
        Spacer(modifier = Modifier.height(20.dp))
        TextField(
            label = { Text(text = AnnotatedString("Confirm password")) },
        ...
        Box(modifier = Modifier.padding(40.dp, 0.dp, 40.dp, 0.dp)) {
            Button(
                ...
                Text(text = AnnotatedString("Register"))
            }
        }
    }
}
